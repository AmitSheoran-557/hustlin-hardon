    ...
    return (
        <div>
            ...
            <div className='w-full border-t-2 border-b-2 border-black px-4'>
                <div className='max-w-[1140px] relative py-[99px] max-lg:py-18 max-md:py-10 mx-auto border-r-2 border-l-2 pl-9 max-sm:pr-3 max-lg:pl-20 max-lg:gap-7 max-sm:gap-6 flex flex-col border-black'>
