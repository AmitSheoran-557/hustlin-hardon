...
const Minting = () => {
    ...
    return (
        <>
            <div id='minting' className="max-[1600px]:max-w-[1920px] lg:max-w-[1172px] md:max-w-[1024px] max-w-[768px] px-4 mx-auto">
            ...
            <div className='flex flex-col w-full justify-center items-center'>
                    ...
                    <div className="flex flex-wrap justify-center items-center lg:border-black lg:border-l-2">
                        <div className="lg:w-6/12 w-full lg:pt-0 pt-6 lg:pe-4">
                            <div className="lg:max-w-[438px] w-full xl:ms-[25px] lg:ms-5 flex flex-col max-lg:items-center">
                                ...
                                <p className='text-green lg:text-lg text-sm lg:mb-2 mb-1 !leading-[100%] font-semibold'>
                                    Time Left
                                </p>
                ...
                <div className="flex flex-wrap xl:gap-[116px] lg:gap-20 md:gap-16 gap-10 justify-center px-7 lg:py-[21px] py-4">
                    {MINTING_ITEMS_DATA.map((item, index) => (
                        <div key={index}>
                            <p className="lg:text-2xl text-lg lg:mb-3 mb-2">{item.text}</p>
