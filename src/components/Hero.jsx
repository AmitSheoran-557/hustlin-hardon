    ...
    return (
        <div className='overflow-hidden'>
            ...
            <div className="px-4 max-[1600px]:max-w-[1920px] lg:max-w-[1172px] md:max-w-[1024px] max-w-[768px] mx-auto">
                ...
                <Image className='mx-auto max-w-[1920px] w-full max-h-[476px] object-cover lg:mt-5 mt-4' src='/assets/images/webp/hero-cabin-img.webp' width={1440} height={476} alt='hero-image' />
        </div>
    )
}
